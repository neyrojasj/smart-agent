...
Update `.github/copilot/docs/skills-opportunities.md` with deferred entries:
...
Update `.github/copilot/context.md` with generated skills:
...
- `.github/copilot/context.md` - Updated available skills
...
1. Check deferred gaps in `.github/copilot/docs/skills-opportunities.md`
