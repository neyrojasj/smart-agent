#!/usr/bin/env bash
#
# afk-claude.sh — Claude Code AFK loop (installed as afk-ralph.sh).
#
...
#   .claude/scripts/afk-ralph.sh [FEATURE]         # FEATURE: .scratch/<feature>/, PRD.md path, or slug
#   .claude/scripts/afk-ralph.sh weft --dry-run    # print the prompt for the next slice, don't run
#
# Env knobs:
