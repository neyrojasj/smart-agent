...
- **Name**: documentation
- **Version**: 1.0
- **Description**: Generates and updates project documentation in `.copilot/docs/`.
...
- `.copilot/docs/` - Where docs live
- `.copilot/standards/markdown.md` - For markdown formatting
...
│                                                                         │
│  Read .copilot/standards/markdown.md if it exists                       │
...
|--------|-----------------|
| Project overview | `.copilot/docs/overview.md` |
| Architecture | `.copilot/docs/architecture.md` |
| Tech stack | `.copilot/docs/tech-stack.md` |
| API endpoints | `.copilot/docs/api.md` |
| Testing | `.copilot/docs/testing.md` |
| Development | `.copilot/docs/development.md` |
| Conventions | `.copilot/docs/conventions.md` |
| Decision | `.copilot/docs/decisions/DEC-XXX.md` |
...
After any doc change, update `.copilot/docs/index.yaml`:
...
`.copilot/docs/decisions/DEC-XXX.md`:
...
Update `.copilot/docs/decisions/index.yaml`:
...
- ❌ Create docs outside `.copilot/docs/`
