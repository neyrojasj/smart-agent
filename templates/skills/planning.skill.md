...
- `.copilot/docs/` - For existing architecture understanding
- `.copilot/standards/` - For coding standards to plan against
...
For MEDIUM and BIG changes, create `.copilot/plans/PLAN-XXX.md`:
...
Update `.copilot/plans/state.yaml`:
...
📄 **Full plan:** `.copilot/plans/PLAN-XXX.md`
...
Before planning, check if `.copilot/standards/` exists and read:
